...
const RoleForm: React.FC<Props> = ({ onCreate, onCancel }) => {
    return (
        <>
            ...
            <div className="fixed left-[50%] top-[50%] z-50 grid w-min max-w-7xl translate-x-[-50%] translate-y-[-50%] shadow-lg bg-white rounded-2xl overflow-hidden">
                <div className="w-6xl">
                    <div className="pt-10 px-8 pb-8 space-y-[30px]">
                        <div className="flex gap-8">
                            {icons.success}
                            <h2 className="text-3xl text-secn-blue font-bold">Crear nuevo rol</h2>
                        </div>
