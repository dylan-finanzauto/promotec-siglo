...
function App() {
    ...
    useEffect(() => {
        ...
        if (token.isAuthenticated) {
            ...
            userMutation.mutate(token.accessToken)
            consMutation.mutate(token.accessToken)
            comMutation.mutate(token.accessToken)
            emailMutation.mutate(token.accessToken)
            sdMutation.mutate(token.accessToken)
            tvMutation.mutate(token.accessToken)
            tdMutation.mutate(token.accessToken)
            tpMutation.mutate(token.accessToken)
            attriMutation.mutate(token.accessToken)
            stateMutation.mutate(token.accessToken)
            typologyMutation.mutate(token.accessToken)
